...
PROJECT_GIT_URL='https://github.com/KoLichung/taxiPortDjango.git'
...
apt-get update
apt-get install -y python3-dev python3-venv sqlite python-pip supervisor nginx git binutils libproj-dev gdal-bin
